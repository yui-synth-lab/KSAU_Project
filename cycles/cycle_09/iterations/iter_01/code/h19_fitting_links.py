...
def main():
    ...
    def objective(params):
        ...
        for d in data:
            ...
            # interaction term: gamma * (C - 1) * K
            ln_m_pred = eta * kappa * (d['V'] + alpha * d['T'] + beta * d['S'] + gamma * (d['C'] - 1) * d['K']) + B
    ...
    results = {
        ...
        "task_name": "Interaction Energy Term Initial Fitting (Link Scaling)",
        "computed_values": {
