...
def main():
    ...
    res = differential_evolution(objective, bounds, args=(data, kappa), 
                                 seed=42, strategy='best1bin', maxiter=3000, tol=1e-8)
    best_p = res.x
    ...
    results = {
        ...
        "task_name": "Final Model Determination and Validation",
        "computed_values": {
