...
\textbf{Authors:} Yui / KSAU Collaboration\\
\textbf{Date:} 2026-03-01\\
\textbf{Version:} draft\_v4\\
\textbf{Status:} UNDER REVIEW\\
\textbf{DOI:}
\href{https://doi.org/10.5281/zenodo.18521244}{10.5281/zenodo.18521244}
...
gravitational constant \(G\) with a precision of \(0.0000263\%\) and
...
The authors acknowledge the use of large language models, including
\textbf{Anthropic Claude} (Sonnet series) and \textbf{Google Gemini}
(2.5/3.0 series), for hypothesis generation, mathematical verification,
and iterative peer review within the AIRDP framework. These tools were
used in accordance with the journal's policies on AI-assisted research.
All statistical criteria were pre-registered before each cycle, and no
post-hoc parameter adjustments were made.

Knot invariant data sourced from the \textbf{KnotInfo} and
\textbf{LinkInfo} databases (Indiana University).
...
\item
  Alexander, J. W. (1928). ``Topological invariants of knots and
  links.'' \emph{Trans. Amer. Math. Soc.}, 30(2), 275-306.
\item
  Jones, V. F. R. (1985). ``A polynomial invariant for knots via von
  Neumann algebras.'' \emph{Bull. Amer. Math. Soc.}, 12(1), 103-111.
\item
  KnotInfo Database (2026). ``Table of Knot Invariants.''
  \url{https://knotinfo.math.indiana.edu/}
\item
  Particle Data Group (2024). Review of Particle Physics. \emph{PTEP},
  2024, 083C01.
\item
  Eto, M., Hamada, Y. \& Nitta, M. (2025). ``Tying Knots in Particle
  Physics.'' \emph{Phys. Rev.~Lett.} 135, 091603. {[}arXiv:2407.11731{]}
\item
  KSAU Project Team. (2026). ``AIRDP Project Status Report: Cycle
  01-26.'' Zenodo. \url{https://doi.org/10.5281/zenodo.18827836}
\end{enumerate}
